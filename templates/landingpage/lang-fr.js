...
module.exports = {
    ...
    image_description:
        "Étapes d'un Processus de Réponse aux Incidents. Graphique: Interrupteur",
    checkbox_error: 'Champ obligatoire non sélectionné',
    labels: {
        select_option: 'Veuillez sélectionner',
        select_label: 'Select',
        anmelden: "S'inscrire",
        radio_text:
